...
IPFS_CLUSTER_CTL_EXECUTABLE=ipfs-cluster-ctl
IPFS_CLUSTER_SERVICE_EXECUTABLE=ipfs-cluster-service
IPFS_CLUSTER_START_SCRIPT=start-ipfs-cluster.sh
...
chmod u+x $INPUT_DIR/$IPFS_CLUSTER_CTL_EXECUTABLE
cp $INPUT_DIR/$IPFS_CLUSTER_CTL_EXECUTABLE ${FULL_NAME}/usr/local/bin/$IPFS_CLUSTER_CTL_EXECUTABLE
chmod u+x $INPUT_DIR/$IPFS_CLUSTER_SERVICE_EXECUTABLE
cp $INPUT_DIR/$IPFS_CLUSTER_SERVICE_EXECUTABLE ${FULL_NAME}/usr/local/bin/$IPFS_CLUSTER_SERVICE_EXECUTABLE
chmod u+x $INPUT_DIR/$IPFS_CLUSTER_START_SCRIPT
cp $INPUT_DIR/$IPFS_CLUSTER_START_SCRIPT ${FULL_NAME}/usr/local/bin/$IPFS_CLUSTER_START_SCRIPT
